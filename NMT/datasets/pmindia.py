...
if __name__ == "__main__":
    ...
    lg_pairs = ['as-en', 'bn-en', 'gu-en','hi-en', 'kn-en','ml-en','mni-en','mr-en','or-en','pa-en','ta-en','te-en','ur-en']
    mono = ['as','bn','en','gu','hi','kn','ml','mni','mr','or','pa','ta','te','ur']
    ...
    for lg in mono:
        ...
        if lg == 'mni':
            lg='mp'                                                                                            #For Manipuri
        join_files(extracted_folder, os.path.join(final_data_path, 'mono', lg+'.mono'), args.delete_old)
